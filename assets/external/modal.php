                    ...
                    <div class="modal-dialog width-400px" role="document">
                                ...
                                <div role="tabpanel" class="tab-pane fade '. $activeTabRegister .'" id="tab-register">
                                    <form id="form-register">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="form-register-name" name="register_name" placeholder="Antonio">
                                        </div>
                                        <!--end form-group-->
                                        <div class="form-group">
                                            <label for="form-register-surname">Surname</label>
                                            <input type="text" class="form-control" id="form-register-surname" name="register_surname" placeholder="Bernabé">
                                        </div>
                                        <!--end form-group-->
                                        <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <div class="center">
                                ...
                                <div>New to WorkSpace? <a href="#">Register an account</a></div>
                            </div>
                        </div>
                        <!--end modal-footer-->
                    </div>
